 ...
 * 
 *  @(#) $Id: jsp_checkscript.cpp 1 2008-08-22 05:57:26Z koban $
 */
...
//      "\tDEFS(TMAX_MAXSEM);\n\n"
    ...
    createScriptEntry(container[OBJECTTREE "/" TASK],      out, "tskatr,exinf,task,ipriority,stksz,stk,texatr,texrtn,stkdef");
